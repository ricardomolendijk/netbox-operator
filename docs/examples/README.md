...
| [`racks.yaml`](racks.yaml) — a rack role, a flat rack group, a catalogue rack type, one rack in a location and one deliberately without, and a reservation on the first | **available** (M9–M10, NBO-051) |
