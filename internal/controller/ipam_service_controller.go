...
// NetBoxService's controller is one line, the same one NetBoxTag's is. A polymorphic pair, a many-to-many and an ordered array on one object, all three as data (internal/registry/ipam_service.go).
