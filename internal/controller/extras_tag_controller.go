...
// +kubebuilder:rbac:groups=netbox.populator.io,resources=netboxtags,verbs=get;list;watch;update;patch
// +kubebuilder:rbac:groups=netbox.populator.io,resources=netboxtags/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=netbox.populator.io,resources=netboxtags/finalizers,verbs=update
