...
func ipamVLANTranslationRuleDescriptor() Descriptor {
	return Descriptor{
		...
		// Deletes and declares no DataLossOnDelete, matching the policy: a rewrite is
		// configuration a manifest recreates, and it would be incoherent for the child to
		// outlive a parent NetBox cascades away anyway (#176, #186, #304,
