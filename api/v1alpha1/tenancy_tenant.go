...
type NetBoxTenantSpec struct {
	...
	// filter omitted, so the lookup pins `?group_id=null` instead of dropping the filter
	// (docs/concepts/lookups.md). Declaring it and having it not resolve yet makes
