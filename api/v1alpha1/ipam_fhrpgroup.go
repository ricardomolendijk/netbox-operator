...
//
// **`auth_key` is deliberately absent from this spec.** `plan.md` §15 permits it only as
// `spec.authKeySecretRef`, never inline, and reading a Secret into a NetBox payload field is
